            ...
            return (
              <div key={index} className=' flex flex-col items-center bg-gray-300 border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-400 mb-5  dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700'>
                ...
                <div className="flex flex-col justify-between p-4 leading-normal">
                  ...
                  <div className=''>
                    <button className='bg-gray-800 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded' onClick={() => handleClick(items)}>Read More</button>
                    <button className="bg-gray-800 hover:bg-gray-600 text-white font-bold ml-2 py-2 px-4 rounded" onClick={() => handleShare(items)}>Share </button>
                    <button className="bg-gray-800 hover:bg-gray-600 text-white font-bold ml-2 py-2 px-2 rounded" onClick={() => add(items)} >Add To Basket</button>
                  </div>
                  {
