  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="https://newsapi.org/" className="hover:underline">News Api</a>
                        </li>
                ...
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="https://github.com/gapavoyan" className="hover:underline ">Github</a>
                        </li>
                        <li>
                            <a href="https://www.aitschool.am/" className="hover:underline">Fantasy Space</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" className="hover:underline">News App™</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://www.facebook.com/search/top?q=ararat%20it%20center" className="text-gray-500 hover:text-gray-100 dark:hover:text-white">
                ...
                <a href="https://www.instagram.com/ararat_itcenter/" className="text-gray-500 hover:text-gray-100 dark:hover:text-white">
                ...
                <a href="https://github.com/gapavoyan" className="text-gray-500 hover:text-gray-100 dark:hover:text-white">
